...
class AuthPage(WebPage):
    ...
    wrong_login_password = WebElement(xpath='//*[@id="forgot_password"]')
    ...
    message_enter_password = WebElement(xpath='// *[ @ id = "page-right"] / div / div / div / form / div[2] / div / span[3]')
    resetback = WebElement(id='reset-back')
    captchares = WebElement(xpath='//*[@id="page-right"]/div/div/div/form/div[2]/div[1]/div[2]')
